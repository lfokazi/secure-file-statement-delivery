...
echo "📋 List Customer statements (by customer ID: 2002)"
echo "================================================"
response=$(curl -s -w "\n%{http_code}" -X GET --location 'http://localhost:8080/v1/api/workforce/documents/customer/statements?customerId=2002' \
